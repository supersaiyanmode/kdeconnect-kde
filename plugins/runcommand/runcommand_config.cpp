...
#include "ui_runcommand_config.h"
...
//     , m_ui(new Ui::ShareConfigUi()) //disabled purely because Dave's QtDesigner is broke
{
//     m_ui->setupUi(this);
...
void RunCommandConfig::load()
{
    ...
    QJsonObject jsonConfig = config()->jsonConfig();
...
void RunCommandConfig::save()
{
    ...
    config()->storeJsonConfig(jsonConfig);
